namespace DPlayer
{
    ...
    public class DPMediaPlayer
    {
        ...
        public DPMediaPlayer()
        {
            ...
            if (File.Exists(appDataPath + @"\PrestonMedia\DPlayer\DPlayerLog.txt"))
            {
                File.Delete(appDataPath + @"\PrestonMedia\DPlayer\DPlayerLog.txt");
            }
        }
        ...
        private void LogMessage(string title, string details)
        {
            ...
            string dpDataPath = pmDataPath + @"\DPlayer";
