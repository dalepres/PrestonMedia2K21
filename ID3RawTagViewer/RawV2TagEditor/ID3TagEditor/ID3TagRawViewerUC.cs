...
namespace Preston.Media
{
    public partial class ID3TagRawViewerUC : UserControl
    {
        ...
        {
            IEnumerator<V2Frame> ie = v22Tag.Frames.GetEnumerator();
            if (ie != null)
            {
                while (ie.MoveNext())
                {
        ...
        private void cbFrames_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (cbFrames.SelectedItem is V2Frame)
            {
                ...
                byteViewer.SetBytes(((V2Frame)cbFrames.SelectedItem).ToByteArray());
            }
            else if (cbFrames.SelectedItem is V22Frame)
            {
                byteViewer.SetBytes(((V22Frame)cbFrames.SelectedItem).ToByteArray());
            }
        }
        ...
        {
            this.lblFrameDescription.Text = string.Empty;
