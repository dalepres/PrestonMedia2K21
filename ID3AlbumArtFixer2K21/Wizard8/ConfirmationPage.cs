    ...
    internal class ConfirmationPage : InternalWizardPage
    {
        ...
        private void DisplayEmbedOptions()
        {
            ...
            else
            {
                ...
                DeleteEmbeddedImages deleteJob = picJob.DeleteExistingImages;
                ...
                if (deleteJob == DeleteEmbeddedImages.None)
                {
                    rtbAlbumArtJob.Text += tab + "Do not delete existing embedded images." + nl;
                }
                else if(deleteJob == DeleteEmbeddedImages.All)
                {
                    rtbAlbumArtJob.Text += tab + "Delete all existing embedded images." + nl;
                }
                else if (deleteJob == DeleteEmbeddedImages.SameType)
                {
