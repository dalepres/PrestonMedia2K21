...
namespace ID3AlbumArtFixer.Wizard
{
    internal class AlbumArtOptionsPage : InternalWizardPage, IAlbumArtFixerJob, IAlbumArtFixerSettings
    {
        ...
        private RadioButton rbAlbumArtFromFileNameThenLargest;
		...
		{
            ID3AlbumArtFixer.Properties.Settings settings1 = new ID3AlbumArtFixer.Properties.Settings();
            this.pnlMain = new System.Windows.Forms.Panel();
            this.pnlOptions = new System.Windows.Forms.Panel();
            this.gbAlbumArtOptions = new System.Windows.Forms.GroupBox();
            this.rbAlbumArtFromFileNameThenLargest = new System.Windows.Forms.RadioButton();
            ...
            // gbAlbumArtOptions
            // 
            this.gbAlbumArtOptions.Controls.Add(this.rbAlbumArtFromFileNameThenLargest);
            ...
            // 
            // rbAlbumArtFromFileNameThenLargest
            // 
            this.rbAlbumArtFromFileNameThenLargest.AutoSize = true;
            settings1.AlbumArtFromFile = "";
            settings1.AlbumArtFromFileNameThenLargest = false;
            settings1.AlbumArtFromLargestImage = true;
            settings1.AlbumArtImageQualityPerCent = 65;
            settings1.AlbumArtMaxHeight = new decimal(new int[] {
            640,
            0,
            0,
            0});
            settings1.AlbumArtMaxWidth = new decimal(new int[] {
            640,
            0,
            0,
            0});
            settings1.CreateResizeAlbumArt = true;
            settings1.EmbedAlbumArt = true;
            settings1.EmbedDeleteAllImages = false;
            settings1.EmbedDeleteImages = true;
            settings1.EmbedEnforceMaximumSize = true;
            settings1.EmbedFileName = "Folder.jpg";
            settings1.EmbedImageDescription = "Scanned CD Cover";
            settings1.EmbedImageMaxHeight = new decimal(new int[] {
            640,
            0,
            0,
            0});
            settings1.EmbedImageMaxWidth = new decimal(new int[] {
            640,
            0,
            0,
            0});
            settings1.EmbedImageType = 3;
            settings1.FullControlAccount = "Backup Operators";
            settings1.ReadOnlyAccount = "Users";
            settings1.SetAlbumArtSecurity = true;
            settings1.SettingsKey = "";
            settings1.SkipWelcomePage = false;
            this.rbAlbumArtFromFileNameThenLargest.Checked = settings1.AlbumArtFromFileNameThenLargest;
            this.rbAlbumArtFromFileNameThenLargest.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "AlbumArtFromFileNameThenLargest", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            this.rbAlbumArtFromFileNameThenLargest.Location = new System.Drawing.Point(217, 99);
            this.rbAlbumArtFromFileNameThenLargest.Name = "rbAlbumArtFromFileNameThenLargest";
            this.rbAlbumArtFromFileNameThenLargest.Size = new System.Drawing.Size(188, 17);
            this.rbAlbumArtFromFileNameThenLargest.TabIndex = 20;
            this.rbAlbumArtFromFileNameThenLargest.Text = "File name or largest if file not found";
            this.rbAlbumArtFromFileNameThenLargest.UseVisualStyleBackColor = true;
            // 
            // chkCreateResizeAlbumArt
            // 
            this.chkCreateResizeAlbumArt.AutoSize = true;
            this.chkCreateResizeAlbumArt.Checked = settings1.CreateResizeAlbumArt;
            this.chkCreateResizeAlbumArt.CheckState = System.Windows.Forms.CheckState.Checked;
            this.chkCreateResizeAlbumArt.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "CreateResizeAlbumArt", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.txtArtSourceFileName.DataBindings.Add(new System.Windows.Forms.Binding("Text", settings1, "AlbumArtFromFile", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.txtArtSourceFileName.Text = settings1.AlbumArtFromFile;
            // 
            // label6
            // 
            ...
            this.rbLargestImage.Checked = settings1.AlbumArtFromLargestImage;
            this.rbLargestImage.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "AlbumArtFromLargestImage", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            // nudMaxHeight
            // 
            this.nudMaxHeight.DataBindings.Add(new System.Windows.Forms.Binding("Value", settings1, "AlbumArtMaxHeight", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.nudMaxHeight.Value = settings1.AlbumArtMaxHeight;
            // 
            // label4
            // 
            ...
            // nudMaxWidth
            // 
            this.nudMaxWidth.DataBindings.Add(new System.Windows.Forms.Binding("Value", settings1, "AlbumArtMaxWidth", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.nudMaxWidth.Value = settings1.AlbumArtMaxWidth;
            // 
            // AlbumArtOptionsPage
            // 
        ...
        public AlbumArtFixerJob UpdateJobFromForm(AlbumArtFixerJob job)
        {
            ...
            if (rbFromFileNamed.Checked)
            {
                job.AlbumArtSource = AlbumArtSource.FileName;
                job.AlbumArtSourceFileName = txtArtSourceFileName.Text.Trim();
            }
            else if (rbAlbumArtFromFileNameThenLargest.Checked)
            {
                job.AlbumArtSource = AlbumArtSource.FileNameThenLargest;
                job.AlbumArtSourceFileName = txtArtSourceFileName.Text.Trim();
            }
            else if (rbLargestImage.Checked)
            {
                job.AlbumArtSource = AlbumArtSource.LargestImage;
                job.AlbumArtSourceFileName = string.Empty;
            }
        ...
        private void SetOptionsEnabled(bool enabled)
        {
            this.nudMaxHeight.Enabled
                ...
                = rbAlbumArtFromFileNameThenLargest.Enabled
